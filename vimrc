...
"hi CursorColumn cterm=italic ctermbg=darkred ctermfg=white guibg=darkred guifg=white
...
cmap cd. lcd %:p:h <cr>
"Edit vimrc
cmap evrc e ~/.vimrc <cr>
"Edit awesome rc.lua
cmap earc e ~/.config/awesome/rc.lua <cr>
"Edit awesome rc.lua
cmap ebrc e ~/.bashrc <cr>
"}
